...
d.maTag = function() {
	try {
		...
		if (scEventExists("event29")) {
            // competition entries
            u1 = u1 + '|ce|' + pCategory + '|' + pString;
            et = 'competition-entries';
            if(s.eVar23) u1 = u1 + '|' + s.eVar23;
            u2  = d.getAmount("event19");
            d.triggerMA(u1, u2, u3, u4, u5, et);
        }
...
d.adserverTags = function() {	
	...
	try { /** Media Attribution Call **/
		...
		if(d.shouldFireAgencyTagsFor('sunaami')) { /** AAMI Brochureware Tags **/
			...
			if(s.pageName == 'in:ami:lp:CTP:landing page') {
				d.imageTag('//pixel.everesttech.net/2243/t?ev_AAMI_CTP_CheckStart=1&ev_transid=' + s.getSessionID());
			}
			if(s.pageName == 'in:ami:lp:CTP:Eligible_$50-Confirmation') {
				d.imageTag('//pixel.everesttech.net/2243/t?ev_AAMI_CTP_PolicyComp=1&ev_transid=' + s.getSessionID());
			}
		...
		if(d.shouldFireAgencyTagsFor('sunapia')) { /** APIA Brochureware Tags **/
            ...
            if(s.pageName == 'in:apa:apia:health-insurance'){
                ...
                var freeCallBtnEle = d.getElementsByClassName('btn2 call-back secure-popup')[0];
                if(freeCallBtnEle){
            ...
            if(s.pageName == 'in:apa:apia:funeral-plan') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=4080583;type=APIAF0;cat=Sunco00;ord=1;num=' + cachebuster + '?');
            }/** APIA Quote Start **/
			if(scEventExists('event8')) {
		...
		if(d.shouldFireAgencyTagsFor('sungio')) { /** GIO Brochureware Tags **/
			...
			if(s.pageName == 'in:gio:lp:CTP:landing page') {
				d.imageTag('//pixel.everesttech.net/1485/t?ev_GIO_CTP_CheckStart=1&ev_transid=' + s.getSessionID());
			}
			if(s.pageName == 'in:gio:lp:CTP:Eligible_$50-Confirmation') {
				d.imageTag('//pixel.everesttech.net/1485/t?ev_GIO_CTP_PolicyComp=1&ev_transid=' + s.getSessionID());
			}
		...
		if(d.shouldFireAgencyTagsFor('sun')) { /** Suncorp Brochureware Tags **/
			...
			var semTags = [
			                {
								...
								pages: [
						                'sp:sun:secapp:sales:superonline:apply:application_started:employersuper_new',
						                'sp:sun:secapp:sales:superonline:apply:application_completed:employersuper_new',
			...
			/** Everday Super Tags **/
			if(s.pageName == 'sp:sun:secapp:sales:superonline:apply:application_started:employersuper_new') {
				d.downStreamTag("transaction","ev_DirectSuperEmployerAppStart=1","","","1589","pixel.everesttech.net");
			}
			if(s.pageName == 'sp:sun:secapp:sales:superonline:apply:application_completed:employersuper_new') {
			...
			if(s.pageName == 'bk:sun:home-loans:genuine-offer') {
				d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_426;cat=2014_0;ord=1;num=' + cachebuster + '?');
			}
            ...
            if(s.pageName == 'bk:sun:loans:home-loans:genuine-offer'){
            	d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_426;cat=2014_0;ord=1;num=' + cachebuster + '?');
            }
			...
			if(s.pageName == 'bk:sun:loans:personal-loans:genuine-offer') {
				d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_497;cat=Perso00;ord=1;num=' + cachebuster + '?');
			}
            ...
            if(s.pageName == 'bk:sun:bank-genuine') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_091;cat=2014_005;ord=1;num=' + cachebuster + '?');
            }
			if(s.pageName == 'bk:sun:about:ways-to-bank:internet-banking:budget-tracker') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_091;cat=2014_002;ord=1;num=' + cachebuster + '?');
            }
            if(s.pageName == 'bk:sun:business-banking') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_091;cat=2014_004;ord=1;num=' + cachebuster + '?');
            }
            if(s.pageName == 'bk:sun:campaign:suncorp-bank-native-mobile-app') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_091;cat=2014_003;ord=1;num=' + cachebuster + '?');
            }
            if(s.pageName == 'bk:sun:savings:savings-accounts') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_091;cat=2014_001;ord=1;num=' + cachebuster + '?');
            }
            if(s.pageName == 'bk:sun:genuinealternative') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_091;cat=2014_005;ord=1;num=' + cachebuster + '?');
            }
            if(s.pageName == 'bk:sun:loans:car-loans:genuine-offer'){
                d.iframeTag('//fls.doubleclick.net/activityi;src=1792027;type=2014_497;cat=Perso0;ord=1;num=' + cachebuster + '?');
            }
			...
			*/
			...
			if(s.pageName == 'in:sun:insurance:life-insurance:funeral-plan') {
                d.iframeTag('//fls.doubleclick.net/activityi;src=4080583;type=Sunco0;cat=Sunco0;ord=1;num=' + cachebuster + '?');
			...
			*/
			...
			if(scEventExists('event18')) {
                ...
                if(s.products.indexOf('car_') > -1 && s.products.indexOf('car_ctp') == -1) {
                ...
                if( s.products.indexOf('everydaysuper_viaib') > -1){
        ...
        /** asteron life **/
        if(s.pageName == 'in:ast:homepage')
        {
            d.downStreamTag("pageview",  "",  "21361",  "", "1589", "pixel.everesttech.net");
            d.gRemarketing('966322701','',window.google_tag_params,true);
        }
